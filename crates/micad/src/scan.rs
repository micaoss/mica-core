...
/// claims its name. Absence is a conformance gap,
...
/// What a service does NOT do that the registry contract requires.
///
...
async fn record_appearance(
    ...
    if !conformance.is_clean() {
        ...
        tracing::warn!(
            ...
            "service does not conform to the service registry contract; \
