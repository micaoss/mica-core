...
export const zhCN: Translation = {
  ...
  network: {
    title: '网络',
    tabs: { interfaces: '接口', wifi: '已知 Wi-Fi', wireguard: 'WireGuard' }, interfaceCount: '{{count}} 个接口', actions: { addInterface: '添加接口' },
    ...
    detail: {
      ...
      address: '地址 / 前缀', gateway: '网关', dns: 'DNS 服务器', save: '审阅并保存',
