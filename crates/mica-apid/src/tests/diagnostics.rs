//! The diagnostic routes: the system-information surface, the telemetry and
...
#[tokio::test]
async fn the_system_info_route_answers_micads_surface_read_only() {
...
// micad failures on the three reads travel under the classification like
